...
window.addEventListener("load", function() {
   ...
   orderForm.elements.orderDate.value = new Date().toLocaleDateString();
...
function calcOrder() {
   ...
   //Cacluate the inital cost of the order
   ...
   //cacluate the sales tax
   var salesTax = 0.005*(initialCost + pCost);
